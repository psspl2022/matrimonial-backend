...
class CreateFamilyDetails extends Migration
{
    ...
    public function up()
    {
        Schema::create('family_details', function (Blueprint $table) {
            ...
            $table->enum('family_type', ['1', '2','3'])->comment('1=Nuclear, 2=Joint, 3=Others,');
            $table->enum('family_values', ['1', '2','3','4'])->comment(' 1=Liberal, 2=Orthodox, 3=Conservative, 4=Moderate,');
            $table->enum('family_status', ['1', '2','3'])->comment(' 1=Rich, 2=Upper-Class, 3=Middle-Class');
