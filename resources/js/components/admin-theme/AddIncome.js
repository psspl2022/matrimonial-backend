...
function AddIncome(){
    ...
    const addIncome = () => {
        axios
        .post(`${window.Url}api/addIncome`,data, headers_data)
        .then(response => {
    ...
    <div className="container-fluid">
        <div className="row">
            <div className="col-sm-12">
                <div className="page-title-box">
                    <div className="row">
                        <div className="col">
                            <h4 className="page-title">Add Income</h4>
        ...
        <form>
            <div className="form-group">
                <label >Income</label>
                <input type="text" name="income" value={income} onChange={e => onInputChange(e)} className="form-control"  placeholder="Enter Income " />
            </div>
            <button type="button" onClick={addIncome} className="btn btn-primary mr-2">Submit</button>
