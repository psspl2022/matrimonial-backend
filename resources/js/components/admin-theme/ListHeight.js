...
function ListHeight(){
    ...
    const headers_data = {
      ...
      useEffect(() => {
        axios.get("http://127.0.0.1:8000/api/getHeightList", headers_data)
          .then(({ data }) => {
                    ...
                    <div className="row">
                        <div className="col-sm-12">
                            <div className="page-title-box">
                                <div className="row">
                                    <div className="col">
                                        <h4 className="page-title">Height List</h4>
                                        <ol className="breadcrumb">
                                            <li className="breadcrumb-item"><Link >Home</Link></li>
                                            <li className="breadcrumb-item"><Link >Master</Link></li>
                                            <li className="breadcrumb-item"><Link >Height</Link></li>
                                            <li className="breadcrumb-item active">Height List</li>
                                        </ol>
                                    </div>
                        ...
                        <div className="col-12">
                            <div className="card">
                                <div className="card-header">
                                    <h4 className="card-title">Height List</h4>
