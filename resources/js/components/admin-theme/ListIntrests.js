...
function ListIntrests(){
    ...
    const headers_data = {
      ...
      useEffect(() => {
        axios.get("http://127.0.0.1:8000/api/getIntrestsList", headers_data)
          .then(({ data }) => {
                    ...
                    <div className="row">
                        <div className="col-sm-12">
                            <div className="page-title-box">
                                <div className="row">
                                    <div className="col">
                                        <h4 className="page-title">Intrests List</h4>
                                        <ol className="breadcrumb">
                                            <li className="breadcrumb-item"><Link >Home</Link></li>
                                            <li className="breadcrumb-item"><Link >Master</Link></li>
                                            <li className="breadcrumb-item"><Link >Intrests</Link></li>
                                            <li className="breadcrumb-item active">Intrests List</li>
                                        </ol>
                                    </div>
                        ...
                        <div className="col-12">
                            <div className="card">
                                <div className="card-header">
                                    <h4 className="card-title">Intrests List</h4>
