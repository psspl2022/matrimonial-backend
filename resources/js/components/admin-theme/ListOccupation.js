...
function ListOccupation(){
    ...
    function listData(){
        axios.get("http://127.0.0.1:8000/api/getOccupationList", headers_data)
          .then(({ data }) => {
                    ...
                    <div className="row">
                        <div className="col-sm-12">
                            <div className="page-title-box">
                                <div className="row">
                                    <div className="col">
                                        <h4 className="page-title">Occupation List</h4>
                                        <ol className="breadcrumb">
                                            <li className="breadcrumb-item"><Link >Home</Link></li>
                                            <li className="breadcrumb-item"><Link >Master</Link></li>
                                            <li className="breadcrumb-item"><Link >Occupation</Link></li>
                                            <li className="breadcrumb-item active">Occupation List</li>
                                        </ol>
                                    </div>
                        ...
                        <div className="col-12">
                            <div className="card">
                                <div className="card-header">
                                    <h4 className="card-title">Occupation List</h4>
                                ...
                                <table id="datatable" className="table table-bordered dt-responsive nowrap" style={{  borderCollapse:"collapse", borderSpacing: "0", width: "100%" }}>
                                       ...
                                       
                                        {
                                            ...
                                            <tr>                                        
                                                <td>{ item.id }</td>
                                                <td>{ item.occupation_category }</td>
