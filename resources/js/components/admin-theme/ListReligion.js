...
function ListReligion(){
    ...
    function listData(){
        axios.get("http://127.0.0.1:8000/api/getReligionList", headers_data)
          .then(({ data }) => {
                    ...
                    <div className="row">
                        <div className="col-sm-12">
                            <div className="page-title-box">
                                <div className="row">
                                    <div className="col">
                                        <h4 className="page-title">Religion List</h4>
                                        <ol className="breadcrumb">
                                            <li className="breadcrumb-item"><Link >Home</Link></li>
                                            <li className="breadcrumb-item"><Link >Master</Link></li>
                                            <li className="breadcrumb-item"><Link >Religion</Link></li>
                                            <li className="breadcrumb-item active">Religion List</li>
                                        </ol>
                                    </div>
                                    
                                    <div clas
                                    sName="col-auto align-self-center">
