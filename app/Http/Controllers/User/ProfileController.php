...
class ProfileController extends Controller
{
    ...
    public function getAllUserProfiles($page = 0)
    {
        ...
        $next = array_search($page, $key);
        $data3 = ["data" => $data, "key" => $key, 'total' =>  $p, 'page' => $c];
